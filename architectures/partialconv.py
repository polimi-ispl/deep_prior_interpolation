...
class PartialConvEncoderBlock(nn.Module):
    ...
    def __init__(self, input_channel, out_channels):
        ...
        self.partialconv = Partial2DConvLayer(input_channel, out_channels, bn=True, activation='leaky_relu')
        self.down = nn.Conv2d(out_channels, out_channels, 3, 2, 1, bias=False)
...
class PartialConvUNet(nn.Module):
    ...
    def __init__(self, input_channel, out_channels):
        ...
        self.decoder_3 = nn.Sequential(
            *[nn.Conv2d(144, 96, 3, 1, 1, bias=False),
              nn.Conv2d(96, 96, 3, 1, 1, bias=False),
              nn.Upsample(scale_factor=2, mode='nearest')])
        ...
        self.outconv = nn.Sequential(
            *[nn.Conv2d(96 + input_channel, 96, 3, 1, 1, bias=False),
              nn.Conv2d(96, 64, 3, 1, 1, bias=False),
              nn.Conv2d(64, 32, 3, 1, 1, bias=False),
              nn.Conv2d(32, out_channels, 3, 1, 1, bias=False)])
...
if __name__ == '__main__':
    ...
    conv = PartialConvUNet(input_channel=64, out_channels=1).type(dtype)
    # l1 = nn.L1Loss()
